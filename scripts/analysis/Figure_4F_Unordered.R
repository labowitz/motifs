...
saveNetwork(s, paste0(fig_dir, "Figure_4F_Unordered.html", sep=""))
webshot::webshot(paste0(fig_dir, "Figure_4F_Unordered.html", sep=""), paste0(fig_dir, "Figure_4F_Unordered.pdf", sep=""), vwidth = 1000, vheight = 900)
