...
input_dir = "./scripts/analysis/outputs/aws_pathways/"
...
make_plts <- function(pathway_name){
  silh_result = paste(input_dir, pathway_name, "_silh_plt.RDS", sep = "")
...
ggsave(paste(output_dir, "Figure_5_figure_supplement_1A.pdf", sep = ""), g, height = 36, width = 16)